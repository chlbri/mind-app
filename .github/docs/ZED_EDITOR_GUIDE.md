...
```json
{
  ...
  "languages": {
    ...
    "JavaScript": { "tab_size": 2, "format_on_save": "on" }
  }
}
```
...
[
  ...
  { "label": "Lint", "command": "pnpm run lint", "reveal": "no_focus" },
...
```json
{
  "snippets": {
    "TypeScript": {
      "console.log": { "prefix": "cl", "body": "console.log('$1:', $1);" }
    }
  }
}
```
...
```json
{ "context": "Editor", "bindings": { "cmd-s": "workspace::Save" } }
```
