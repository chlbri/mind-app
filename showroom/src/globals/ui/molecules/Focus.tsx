import { onMount, type Component, type ComponentProps, type ValidComponent } from "solid-js";
...
function _forwardFocus<T2 extends ValidComponent>(focus: FocusFn<T2>) {
  return <T extends ComponentProps<T2>>(Compt: Component<T>) => _focus(Compt, focus as any);
}
...
export function forwardFocus<T2 extends Component<any>>(children: T2, focus: FocusFn<T2>): T2;

export function forwardFocus<T2 extends ValidComponent>(arg1: any, arg2?: FocusFn<T2>) {
