...
import { createLinks, formatLabel1 as formatLabel } from "src/globals/ui/signals/links";
import type { PropsOf } from "src/globals/ui/types";

type LinkProps = Omit<ReturnType<typeof createLinks>[number], "children" | "search"> &
