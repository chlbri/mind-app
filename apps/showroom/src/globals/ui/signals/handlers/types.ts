...
/**
 * Return type for conditional event handlers providing manual add/remove
 * triggers.
 *
 ...
 *
 * @template | `keyof HTMLElementEventMap` `K` - DOM event name key type
 *   from interface {@linkcode HTMLElementEventMap}.
 *
 * @param args - Event listener configuration options.
 * @param args.type - Event type name to listen for.
 * @param args.listener - Callback listener function invoked on event
 *   trigger.
 * @param args.options - Optional configuration for event listener
 *   registration and removal.
 * @param args.options.add - Options passed when adding the event listener
 *   of interface {@linkcode AddEventListenerOptions} or `boolean`.
 * @param args.options.remove - Options passed when removing the event
 *   listener of interface {@linkcode EventListenerOptions} or `boolean`.
 * @param condition - Boolean condition or accessor of type
 *   {@linkcode Accessor} controlling whether the event is active.
 *
 * @returns Object of type {@linkcode _Return} with `add` and `remove`
 *   methods to manage the event manually.
 */
...
/**
 * Conditional DOM event handler attachment function signature accepting an
 ...
 *
 * @param ref - Optional accessor of type {@linkcode Accessor} returning
...
/**
 * Unconditional DOM event handler attachment function signature accepting
 * an element ref accessor.
 *
 * @template | {@linkcode HTMLElement} | {@linkcode Window} | undefined `T`
 *
 *   - Target DOM element or window type.
...
/**
 * Higher-order event handler factory signature combining standard and
 ...
 *   {@linkcode Accessor}.
 *
 * @returns An event handler function of type {@linkcode Normal} with
 *   attached `conditional` handler of type {@linkcode Conditional}.
 */
export type Handler = <
